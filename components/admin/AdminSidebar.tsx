  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-3 bg-emerald-600 text-white rounded-xl shadow-lg hover:bg-emerald-700 transition-colors"
      >
      ...
      {/* Sidebar */}
      <aside className={cn(
        "fixed top-0 left-0 z-40 h-screen w-72 bg-white border-r border-emerald-100 shadow-xl transition-transform duration-300",
        "lg:translate-x-0",
        mobileMenuOpen ? "translate-x-0" : "-translate-x-full"
      )}>
        <div className="flex flex-col h-full">
          {/* Header - Only Logo, No User Info */}
